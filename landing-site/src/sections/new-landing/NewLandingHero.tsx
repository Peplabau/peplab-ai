...
import CountUp from '@/components/new-landing/CountUp';
import WriteInText from '@/components/new-landing/WriteInText';
import { useNewLandingReveal } from '@/hooks/useNewLandingReveal';
import { normalizeImageUrl, getStaticProducts } from '@/lib/static-data';
